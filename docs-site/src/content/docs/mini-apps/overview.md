...
description: Rich interactive UIs generated by Kins, embedded directly in the KinBot sidebar.
---
...
- [Getting Started](/kinbot/docs/mini-apps/getting-started/) — Build your first mini-app
- [Components](/kinbot/docs/mini-apps/components/) — Browse the component library
- [Hooks](/kinbot/docs/mini-apps/hooks/) — React hooks for KinBot integration
- [SDK Reference](/kinbot/docs/mini-apps/sdk-reference/) — Complete SDK API
- [Backend](/kinbot/docs/mini-apps/backend/) — Server-side logic with _server.js
