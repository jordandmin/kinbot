...
const channels: Channel[] = [
  {
    name: 'Telegram',
    description: 'Full bot integration with inline keyboards and media support.',
    Icon: ({ size = 24, ...props }) => (
  ...
  {
    name: 'Discord',
    description: 'Gateway WebSocket with typing indicators and message splitting.',
    Icon: ({ size = 24, ...props }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  {
    name: 'Slack',
    description: 'Events API webhook with signature verification and threading.',
    Icon: ({ size = 24, ...props }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  {
    name: 'WhatsApp',
    description: 'Business Cloud API with webhook verification.',
    Icon: ({ size = 24, ...props }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  {
    name: 'Signal',
    description: 'Via signal-cli REST API for maximum privacy.',
    Icon: ({ size = 24, ...props }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  {
    name: 'Matrix',
    description: 'Client-Server API with long-polling sync and typing indicators.',
    Icon: ({ size = 24, ...props }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  return (
    <section id="channels" className="px-6 py-24 max-w-5xl mx-auto">
      <div className="text-center mb-16">
        ...
        >
          Connect your Kins to 6 messaging platforms. They respond, send media, and maintain context across channels.
        </p>
      </div>
